...
export const getAllCategories = () =>
  fetch(`${api}/categories`, defaultParameters).then(response =>
    response.json()
  );

export const getPostsByCategory = category =>
  fetch(`${api}/${category}/posts`, defaultParameters).then(response =>
    response.json()
  );

export const getAllPosts = () =>
  fetch(`${api}/posts`, defaultParameters).then(response => response.json());
...
export const getPost = postId =>
  fetch(`${api}/posts/${postId}`, defaultParameters).then(response =>
    response.json()
  );
...
export const getPostComments = postId =>
  fetch(`${api}/posts/${postId}/comments`, defaultParameters).then(response =>
    response.json()
  );
